        ...
        # --- PERSONALIDAD 3: AGENTE NEWSLETTER ---
            ...
            if lang == 'en':
                sys_instruction = (
                    ...
                    "Structure:\n"
                    "1. HOOK: One engaging sentence about why this topic caught your attention.\n"
                    ...
                    "- CRITICAL: Use DOUBLE LINE BREAKS between each paragraph. This is essential for readability.\n"
                    "- Use 2-3 subtle emojis to make it more friendly (like 🔍, 💡, 🎯, ✨, 📊).\n"
                ...
                sys_instruction = (
                    ...
                    "Reglas de Formato:\n"
                    "- Escribe 3-4 párrafos CORTOS (2-3 frases cada uno).\n"
                    "- CRÍTICO: Usa DOBLE SALTO DE LÍNEA entre cada párrafo. Esto es esencial para la legibilidad.\n"
                    "- Usa 2-3 emoticonos sutiles para hacerlo más amigable (como 🔍, 💡, 🎯, ✨, 📊).\n"
